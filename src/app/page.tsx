    ...
    <div className="bg-brand-blue text-brand-black selection:bg-brand-black selection:text-brand-white font-sans">
      ...
      <div className="h-[3000px] relative w-full">
        ...
        <motion.nav 
          ...
          className="w-full z-50 px-6 py-2 md:px-12 md:py-4 flex items-center justify-between h-20 md:h-24"
        >
          <Link href="/" className="flex items-center gap-3 cursor-pointer group -my-12 md:-my-16">
          ...
          <div className="flex items-center gap-3 md:gap-5">
            ...
            <button
              onClick={openCart}
              className="relative p-2 md:p-3 hover:scale-110 active:scale-95 transition-transform flex items-center justify-center cursor-pointer"
        ...
        <main className="flex-1 relative w-full px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 z-40 pointer-events-none overflow-visible flex items-end justify-start">
          <div className="w-1/2 flex justify-start sm:justify-center items-end pb-[6vh] sm:pb-[7vh] md:pb-[8vh] pointer-events-none overflow-visible pl-2 sm:pl-6 md:pl-10">
            <motion.div 
              ...
              className="w-full max-w-[240px] sm:max-w-[300px] md:max-w-[360px] lg:max-w-[420px] xl:max-w-[500px] 2xl:max-w-[580px] overflow-visible pointer-events-auto"
            >
              <AnimatedProductBag />
            </motion.div>
          </div>
      ...
      {/* Footer */}
      <footer className="w-full bg-brand-black text-brand-white py-16 px-6 md:px-12 border-t-8 border-brand-black overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          >
            ...
            <div className="flex border-4 border-brand-white rounded-2xl overflow-hidden focus-within:border-brand-blue transition-colors">
              ...
              <button className="bg-brand-white text-brand-black px-4 py-3 font-bold hover:bg-brand-blue transition-colors cursor-pointer">→</button>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div 
          ...
          className="max-w-7xl mx-auto mt-16 pt-8 border-t-2 border-brand-white/20 text-center font-bold"
        >
